...
<style>
	...
	.card-movie .card-header {
		background: #ff9600
	}
	
	.card-card-game .card-header {
		background: #3f51b5
	}
	...
	.card-movie .card-thumb {
		border-color: #ff9600;
	}
	
	.card-card-game .card-thumb{
		background: #3f51b5;
	}
